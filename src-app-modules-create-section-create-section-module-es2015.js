...
let CreateSectionComponent = class CreateSectionComponent {
    ...
    saveSectionDetails() {
        ...
        this.discussionfourmService.createSectionDetails(this.sectionObj).subscribe((res) => {
            this.response = res;
            this.sectionObj.name = "";
            this.sectionObj.description = "";
            this.sucesserror = "Section Created Successfully";
            jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
        });
    }
};
CreateSectionComponent.ctorParameters = () => [
...
let CreateSectionModule = class CreateSectionModule {
};
...
//# sourceMappingURL=src-app-modules-create-section-create-section-module-es2015.js.map