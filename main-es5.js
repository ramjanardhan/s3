...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addItem = function (flage) {
        this.flage = flage;
    };
...
var CreateQuoteService = /** @class */ (function () {
    function CreateQuoteService(httpClient) {
        this.httpClient = httpClient;
        this.baseUrl = "" + src_environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].serviceBaseUrl;
    }
    CreateQuoteService.prototype.searchCustomerDetails = function (searchCustomerDetails) {
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(commonService, datepipe, createQuoteService) {
    ...
    HomeComponent.prototype.getVirtualWallet = function () {
        var _this = this;
        this.userID = 1;
...
var LoginPageComponent = /** @class */ (function () {
    function LoginPageComponent(datepipe, createQuoteService, commonService, okta, changeDetectorRef) {
        this.datepipe = datepipe;
        this.createQuoteService = createQuoteService;
        this.commonService = commonService;
        this.okta = okta;
            ...
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = this;
                        return [4 /*yield*/, this.oktaSignIn.authClient.token.getUserInfo()];
                    case 1:
                        _a.user = _b.sent();
                        return [3 /*break*/, 3];
                    case 2:
    ...
    LoginPageComponent.prototype.showLogin = function () {
        var _this = this;
        this.oktaSignIn.renderEl({ el: '#okta-login-container' }, function (response) {
            if (response.status === 'SUCCESS') {
                _this.user = response.tokens.idToken.claims.email;
                _this.toggle.emit(_this.loginFlage);
    ...
    LoginPageComponent.prototype.logout = function () {
        var _this = this;
        this.oktaSignIn.authClient.signOut(function () {
...
var HeaderComponent = /** @class */ (function () {
    ...
    HeaderComponent.prototype.ngOnInit = function () {
        var _this = this;
        this.commonService.getProductsByLOB().subscribe(function (res) {
            _this.lobList = res;
        });
        // jQuery(function () {
        //   amazonmenu.init({
