...
var FileUploadService = /** @class */ (function () {
    ...
    //   data,httpOptions);
    // }
    FileUploadService.prototype.uploadFile = function (data) {
        console.log(data);
    ...
    FileUploadService.prototype.getuploadedData = function () {
...
var FileUploadComponent = /** @class */ (function () {
    function FileUploadComponent(datepipe, createQuoteService, commonService, fileuploadService) {
    ...
    FileUploadComponent.prototype.excelUpload = function () {
        var _this = this;
        ...
        this.fileuploadService
            ...
            if (res != "") {
                ...
                _this.sucesserror = _this.response.message;
                jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
            }
        }, function (error) {
            _this.sucesserror = 'There is some problem for uploading the sheet. Please contact to Administrator';
            jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
        });
    };
    FileUploadComponent.prototype.getuploadedData = function () {
        var _this = this;
        this.fileuploadService
            .getuploadedData()
            .subscribe(function (res) {
            ...
            _this.sucesserror = 'There is some problem for getting the uploaded data. Please contact to Administrator';
            jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
        });
    };
...
//# sourceMappingURL=src-app-modules-file-upload-file-upload-module-es5.js.map