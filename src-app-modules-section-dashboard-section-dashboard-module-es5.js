...
var SectionDashboardComponent = /** @class */ (function () {
    function SectionDashboardComponent(datepipe, createQuoteService, commonService, discussionforumService) {
    ...
    SectionDashboardComponent.prototype.ngOnInit = function () {
        this.getSectionDashboardDetails();
    };
    SectionDashboardComponent.prototype.getSectionDashboardDetails = function () {
        var _this = this;
        this.discussionforumService
            .getSectionDashboardDetails()
            .subscribe(function (res) {
            _this.sectionDataList = res;
            console.log(_this.sectionDataList);
        }, function (error) { return function () {
        }; });
    };
    SectionDashboardComponent.ctorParameters = function () { return [
    ...
    return SectionDashboardComponent;
}());
...
var SectionDashboardModule = /** @class */ (function () {
    function SectionDashboardModule() {
    }
...
//# sourceMappingURL=src-app-modules-section-dashboard-section-dashboard-module-es5.js.map