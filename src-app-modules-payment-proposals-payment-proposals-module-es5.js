...
var PaymentProposalComponent = /** @class */ (function () {
    function PaymentProposalComponent(datepipe, createQuoteService) {
        this.datepipe = datepipe;
        this.createQuoteService = createQuoteService;
    }
    PaymentProposalComponent.prototype.ngOnInit = function () { };
    PaymentProposalComponent.ctorParameters = function () { return [
    ...
    return PaymentProposalComponent;
}());
...
var PaymentProposalModule = /** @class */ (function () {
    function PaymentProposalModule() {
    }
...
//# sourceMappingURL=src-app-modules-payment-proposals-payment-proposals-module-es5.js.map