...
var CreateQuoteComponent = /** @class */ (function () {
    function CreateQuoteComponent(datepipe, createQuoteService, commonService) {
    ...
    CreateQuoteComponent.prototype.getCustomerTypeList = function () {
        var _this = this;
        this.commonService.getCustomerType().subscribe(function (res) {
            _this.customerTypeList = res;
        });
    };
    CreateQuoteComponent.prototype.onChangeCustomerType = function (customerType) {
        var _this = this;
        if (customerType == "Individual") {
            this.commonService.getSalutation(customerType).subscribe(function (res) {
                _this.salutationList = res;
            });
        }
        else {
            this.salutationList = [
    ...
    CreateQuoteComponent.prototype.gettoken = function () {
        var _this = this;
        this.commonService.getToken().subscribe(function (res) {
            _this.token = res;
        }, function (error) {
            _this.token = error.error.text;
        });
    };
    CreateQuoteComponent.prototype.validations = function () {
    ...
    CreateQuoteComponent.prototype.getCustomerDetails = function () {
        var _this = this;
    ...
    CreateQuoteComponent.prototype.removeModelData = function () {
    ...
    CreateQuoteComponent.prototype.createQuoteDetails = function () {
        var _this = this;
        ...
        this.createQuoteService.createQuoteDetails(this.createQuoteData).subscribe(function (res) {
            _this.createQuoteResponse = res;
        }, function (error) {
            alert(error.error.text);
        });
    };
    CreateQuoteComponent.prototype.getCustomerDetailsById = function (customerID) {
        var _this = this;
        ...
        this.createQuoteService
            ...
            .subscribe(function (res) {
            _this.customerDetailsBySelect = res;
            _this.customerDetailsBySelect = _this.customerDetailsBySelect.lovtypes.lovtype[0];
            _this.createQuoteData.objCVCustomer.mailLocation.areaVillageName = _this.customerDetailsBySelect.areaVillage;
            _this.createQuoteData.objCVCustomer.mailLocation.cityDistrictName = _this.customerDetailsBySelect.cityDistrict;
            _this.createQuoteData.objCVCustomer.customerUniqueID = _this.customerDetailsBySelect.customerID;
            _this.createQuoteData.objCVCustomer.firstName = _this.customerDetailsBySelect.customerName;
            _this.createQuoteData.objCVCustomer.customerType = "I";
            _this.createQuoteData.objCVCustomer.mailLocation.pinCode = _this.customerDetailsBySelect.pinCode;
            _this.createQuoteData.objCVCustomer.mailLocation.pinCodeLocality = _this.customerDetailsBySelect.pinCodeLocality;
            _this.createQuoteData.objCVCustomer.mailLocation.stateName = _this.customerDetailsBySelect.state;
            _this.removeModelData();
        }, function (error) { return function () {
        }; });
    };
    CreateQuoteComponent.ctorParameters = function () { return [
...
var CreateQuoteModule = /** @class */ (function () {
    function CreateQuoteModule() {
    }
...
//# sourceMappingURL=src-app-modules-create-quote-create-quote-module-es5.js.map