...
var PaymentsComponent = /** @class */ (function () {
    function PaymentsComponent(commonservice, location, router, route, createQuoteService) {
    ...
    PaymentsComponent.prototype.onChangeLoadMoney = function () {
        this.multiplePaymentsList = [];
    };
    PaymentsComponent.prototype.getPayementCalDetails = function () {
        var _this = this;
        this.selectedPayments.forEach(function (item) {
            _this.totalPremium = item.totalPremium + _this.totalPremium;
        });
    ...
    PaymentsComponent.prototype.ngOnInit = function () {
        ...
        this.route.params.subscribe(function (params) {
            if (params.routerFrom == "/home/paymentpending") {
                _this.loadmoneyto = params.routerFrom;
                _this.selectedPayments = Object.assign([], JSON.parse(localStorage.getItem('selectedPayments')));
                _this.getPayementCalDetails();
            }
            else if (params.routerFrom == "/wallet") {
                _this.selectedPayments = [];
                _this.loadmoneyto = params.routerFrom;
            }
            else {
                _this.selectedPayments = [];
    ...
    PaymentsComponent.prototype.deleteSelectedItem = function (paymentItem) {
        var index = this.selectedPayments.indexOf(paymentItem);
        if (index !== -1) {
    ...
    PaymentsComponent.prototype.validation = function () {
        if (this.isPaymentTypeSingle) {
    ...
    PaymentsComponent.prototype.makePayment = function () {
        this.payment();
    ...
    PaymentsComponent.prototype.payment = function () {
        var myWindow = window.open("http://ec2-13-233-60-5.ap-south-1.compute.amazonaws.com:7776", "_self");
    };
    PaymentsComponent.prototype.payment1 = function () {
        var _this = this;
        this.validation();
        if (this.isPaymentTypeSingle) {
            if (!this.isPaymentModeForSingle &&
                ...
                this.createQuoteService.makePayment(this.inputForPayment).subscribe(function (res) {
                    _this.onClickmakePayment = false;
                    console.log(res);
    ...
    PaymentsComponent.prototype.setPaymentType = function () {
    ...
    PaymentsComponent.prototype.getVirtualWallet = function () {
        var _this = this;
    ...
    PaymentsComponent.prototype.displaySumAmount = function () {
    ...
    PaymentsComponent.prototype.resetPaymentType = function () {
        this.loadMoneyToWalletForm.patchValue({
            amountFormultiple: 0,
            amountForSingle: 0
        });
    ...
    PaymentsComponent.prototype.onChangePaymentTypeSingle = function () {
        this.loadMoneyToWalletForm.patchValue({
    ...
    PaymentsComponent.prototype.onChangePaymentTypeMultiple = function () {
        this.loadMoneyToWalletForm.patchValue({
            amountFormultiple: null,
            amountForSingle: null
        });
    ...
    PaymentsComponent.prototype.addPayment = function () {
        ...
        if (!this.isPaymentModeForMultiple && !this.isAmountEmpty) {
            if (!this.multiplePaymentsList.some(function (item) { return item.paymentMode == _this.loadMoneyToWalletForm.value.paymentMode; })) {
                this.isDuplicatePaymentModeSelected = false;
                this.loadMoneyToWalletForm.patchValue({
    ...
    PaymentsComponent.prototype.deletePayment = function (i) {
        this.multiplePaymentsList.splice(i, 1);
        this.calulatePaymentListSum();
    };
    PaymentsComponent.prototype.editPayment = function (i) {
        this.loadMoneyToWalletForm.setValue(this.multiplePaymentsList[i]);
        this.editPaymentRecord = true;
        this.editRecordIndex = i;
    };
    PaymentsComponent.prototype.calulatePaymentListSum = function () {
        var e_1, _a;
        this.sumOfPayments = 0;
        try {
            for (var _b = tslib__WEBPACK_IMPORTED_MODULE_0__["__values"](this.multiplePaymentsList), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    PaymentsComponent.prototype.isNumber = function (event) {
        var pattern = /[0-9.]/;
...
//# sourceMappingURL=src-app-modules-payments-payments-module-es5.js.map