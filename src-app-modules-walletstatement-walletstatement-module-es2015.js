...
class WalletStatement {
    constructor(customerId, creditOrdebit, paymentMode, viewBy, customFromDate, customToDate, transactionType, collectioIdOrPolicyNumber, transactionNumber, instrumentNumber, amountRangeFrom, amountRangeTo) {
...
WalletStatement.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
WalletStatementService.ctorParameters = () => [
...
let WalletstatementComponent = class WalletstatementComponent {
    constructor(walletStatementService, createQuoteService) {
    ...
    getDataForWalletStatement() {
        //this.walletStatementParams.customerId = 'IMD1000444';
        this.walletStatementService.getDataForWalletStatement(this.walletStatementParams1).subscribe((res) => {
            this.walletResponseForGrid = res;
            console.log(res);
        }, (error) => {
            // alert(error.error.text);
        });
    ...
    getpaymentmodes() {
        this.walletStatementService.getpaymentmodes().subscribe((res) => {
    ...
    getTransactiontypes() {
        this.walletStatementService.getTransactiontypes().subscribe((res) => {
    ...
    exportDataToExcel() {
        //this.walletStatementParams.customerId = 'IMD1000444';
        this.walletStatementService.exportDataToExcel(this.walletStatementParams1).subscribe((res) => {
            this.dataForPdf = res;
            this.blob = new Blob([this.dataForPdf], { type: 'application/vnd.ms-excel' });
    ...
    exportDataToPdf() {
        //this.walletStatementParams.customerId = 'IMD1000444';
        this.walletStatementService.exportDataToPdf(this.walletStatementParams1).subscribe((res) => {
            this.dataForPdf = res;
            this.blob = new Blob([this.dataForPdf], { type: 'application/pdf' });
            var downloadURL = window.URL.createObjectURL(res);
            var link = document.createElement('a');
            link.href = downloadURL;
...
WalletstatementComponent.ctorParameters = () => [
...
let WalletstatementModule = class WalletstatementModule {
};
...
//# sourceMappingURL=src-app-modules-walletstatement-walletstatement-module-es2015.js.map