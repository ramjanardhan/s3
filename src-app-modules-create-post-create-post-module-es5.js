...
var CreatePostComponent = /** @class */ (function () {
    function CreatePostComponent(datepipe, createQuoteService, commonService, discussionfourmService) {
    ...
    CreatePostComponent.prototype.onSectionChange = function (event) {
        this.objPost.id = event.target.value;
        console.log(this.objPost.id);
    };
    CreatePostComponent.prototype.getTopicList = function () {
        var _this = this;
        this.discussionfourmService.getAllTopics().subscribe(function (res) {
            _this.topicList = res;
            console.log(res);
        });
    };
    CreatePostComponent.prototype.createPostDetails = function () {
        var _this = this;
        ...
        this.discussionfourmService.createPostDetails(this.objPost).subscribe(function (res) {
            _this.respone = res;
            console.log(_this.respone);
            _this.objPost.content = "";
            _this.objPost.id = "";
            _this.sucesserror = "Post Created Successfully";
            jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
        });
    };
...
//# sourceMappingURL=src-app-modules-create-post-create-post-module-es5.js.map