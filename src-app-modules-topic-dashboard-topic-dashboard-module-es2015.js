...
let TopicDashboardComponent = class TopicDashboardComponent {
    ...
    getAllTopics(id) {
        this.discussionforumService
            ...
            .subscribe((res) => {
            this.topicDataList = res;
            console.log(this.topicDataList);
        }, (error) => () => {
        });
    }
};
TopicDashboardComponent.ctorParameters = () => [
...
let TopicDashboardModule = class TopicDashboardModule {
};
...
//# sourceMappingURL=src-app-modules-topic-dashboard-topic-dashboard-module-es2015.js.map