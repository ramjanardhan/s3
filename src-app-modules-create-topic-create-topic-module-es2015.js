...
let CreateTopicComponent = class CreateTopicComponent {
    ...
    getSectionList() {
        this.discussionfourmService.getAllSections().subscribe((res) => {
    ...
    saveTopicDetails() {
        ...
        this.discussionfourmService.createTopicDetails(this.objTopic).subscribe((res) => {
            this.respone = res;
            console.log(this.respone);
            this.objTopic.section.id = "";
            this.objTopic.title = "";
            this.objTopic.content = "";
            this.sucesserror = "Topic Created Successfully";
            jquery__WEBPACK_IMPORTED_MODULE_3__("#AlertModal").show();
        });
    }
};
CreateTopicComponent.ctorParameters = () => [
...
let CreateTopicModule = class CreateTopicModule {
};
...
//# sourceMappingURL=src-app-modules-create-topic-create-topic-module-es2015.js.map