...
var EditprodisplayComponent = /** @class */ (function () {
    function EditprodisplayComponent(createQuoteService, commonService, router) {
    ...
    EditprodisplayComponent.prototype.ngOnInit = function () { };
    EditprodisplayComponent.prototype.rotateIcon = function (iconID) {
        switch (iconID) {
            case 1:
    ...
    EditprodisplayComponent.prototype.gettoken = function () {
        var _this = this;
        this.commonService.getToken().subscribe(function (res) {
            _this.token = res;
            _this.userProfileDetails();
        }, function (error) {
            _this.token = error.error.text; // body
            _this.userProfileDetails();
        });
    };
    EditprodisplayComponent.prototype.userProfileDetails = function () {
        var _this = this;
        this.searchParams.token = this.token;
        this.createQuoteService.userProfileDetails(this.searchParams).subscribe(function (res) {
            _this.userDetails = res;
            console.log(_this.userDetails);
        }, function (error) { return function () { }; });
    };
    EditprodisplayComponent.prototype.saveUserProfileDetails = function (userdetails) {
        var _this = this;
    ...
    EditprodisplayComponent.ctorParameters = function () { return [
    ...
    return EditprodisplayComponent;
}());
...
var MainProfileComponent = /** @class */ (function () {
    function MainProfileComponent(createQuoteService, commonService) {
        this.createQuoteService = createQuoteService;
        this.commonService = commonService;
        this.rotateIcon1 = false;
        this.rotateIcon2 = false;
    ...
    MainProfileComponent.prototype.rotateIcon = function (iconID) {
        switch (iconID) {
            case 1:
                this.rotateIcon1 = !this.rotateIcon1;
                break;
    ...
    MainProfileComponent.prototype.userProfileDetails = function () {
        var _this = this;
        this.searchParams.token = this.token;
        this.createQuoteService.userProfileDetails(this.searchParams).subscribe(function (res) {
    ...
    MainProfileComponent.prototype.gettoken = function () {
        var _this = this;
        this.commonService.getToken().subscribe(function (res) {
            _this.token = res;
            _this.userProfileDetails();
    ...
    MainProfileComponent.ctorParameters = function () { return [
        { type: src_app_core_services_create_quote_service__WEBPACK_IMPORTED_MODULE_2__["CreateQuoteService"] },
