...
var PostDashboardComponent = /** @class */ (function () {
    function PostDashboardComponent(datepipe, createQuoteService, commonService, discussionforumService, _Activatedroute) {
    ...
    PostDashboardComponent.prototype.getAllPosts = function (id) {
        var _this = this;
        this.discussionforumService
            .getAllPostDashboardDataByTopicID(id)
            .subscribe(function (res) {
            _this.postDataList = res;
            console.log(_this.postDataList);
        }, function (error) {
        });
    };
    PostDashboardComponent.prototype.postDownVote = function (postID) {
        var _this = this;
        ...
        this.discussionforumService.
            ...
            .subscribe(function (res) {
            _this.respone = res;
            _this.getAllPosts(_this.id);
        });
    };
    PostDashboardComponent.prototype.postUpVote = function (postID) {
        var _this = this;
        this.objPostLike.id = postID;
    ...
    PostDashboardComponent.prototype.postRate = function (postID, postRate) {
        var _this = this;
        this.objPostLike.id = postID;
...
var PostDashboardModule = /** @class */ (function () {
    function PostDashboardModule() {
    }
...
//# sourceMappingURL=src-app-modules-post-dashboard-post-dashboard-module-es5.js.map